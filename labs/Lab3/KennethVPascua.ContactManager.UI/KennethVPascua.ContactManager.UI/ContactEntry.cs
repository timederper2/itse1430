...
namespace KennethVPascua.ContactManager.UI
{
    public partial class ContactEntry : Form
    {
        ...
        private void OnSave ( object sender, EventArgs e )
        {
            ...
            contact.Title = _txtFirstName.Text;
            contact.Description = _txtLastName.Text;
            contact.IsClassic = _chkFavoriteContact.Checked;
            contact.RunLength = _txtEmail.Text;
            contact.ReleaseYear = _txtNotes.Text;
